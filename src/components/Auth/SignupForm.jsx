    ...
    if (validateEmail() && validatePassword() && validateUserTypeFields()) {
      try {
        ...
        setErrorMessage((prev) => ({
          ...prev,
          genereal: "회원가입에 실패했습니다. 다시 시도해주세요.",
        }));
      }
    }
  };
        ...
        <div style={styles.card}>
          ...
          <form onSubmit={handleSubmit} style={styles.signupForm}>
            ...
            <div style={styles.formGroup}>
              ...
              />
              {errorMessage.email && (
                <p style={{ color: "red", fontSize: "12px" }}>{errorMessage.email}</p>
              )}
            </div>
            ...
            <div style={styles.formGroup}>
              ...
              {errorMessage.password && (
                <p style={{ color: "red", fontSize: "12px" }}>{errorMessage.password}</p>
              )}
            </div>
            ...
            {userType === "guest" && (
              <div style={styles.formGroup}>
                ...
                {errorMessage.nickname && (
                  <p style={{ color: "red", fontSize: "12px" }}>{errorMessage.nickname}</p>
                )}
              </div>
            )}
            ...
            {userType === "boss" && (
              <div style={styles.formGroup}>
                ...
                {errorMessage.address && (
                  <p style={{ color: "red", fontSize: "12px" }}>{errorMessage.address}</p>
                )}
              </div>
            )}
            ...
            <div style={styles.formGroup}>
              ...
              />
              {errorMessage.name && (
                <p style={{ color: "red", fontSize: "12px" }}>{errorMessage.name}</p>
              )}
            </div>
